    ...
    def console():
        ...
        while z == True:
            ...
            if cns_in == "ls" or cns_in == "LS" or cns_in == "lS" or cns_in == "lS":
                cls()
                print(f"COMMAND PROMPT >{cns_in}") ; sleep(0.1)
                print(f"Converting Command [ls] > [dir /s]") ; sleep(0.1)
                print(f"COMMAND PROMPT >dir /s")
                system("dir /s")
            ...
            elif cns_in =="HELP" or cns_in =="help" or cns_in =="Help" or cns_in =="hElp" or cns_in =="HElp" or cns_in =="heLp" or cns_in =="HeLp" or cns_in =="HELp" or cns_in =="helP" or cns_in =="helP" or cns_in =="heLP" or cns_in =="HelP" or cns_in =="HeLP" or cns_in =="HElP" or cns_in =="hELP" or cns_in =="HELp":
                cls()
                print(f"COMMAND PROMPT >{cns_in}")
                system("help")
